"""
Archivo: app.py
Descripción: Servidor Flask para servir la aplicación de cálculo de distancia entre dos puntos
"""
...
def api_calcular():
    """API para calcular la distancia"""
    try:
        datos = request.json
        x1 = float(datos['x1'])
        y1 = float(datos['y1'])
